            ...
            <Row>
              <Col lg="8">
                <div className="card-body">
                    ...
                    <p className="w-responsive mx-auto pb-5">Islamic Institute was the first to be established in 1966 while the Nursery &amp; primary school and comprehensive college(ICC) were established in 1994 &amp; 1996 respectively.
